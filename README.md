...
- AI 기술과 RTC를 활용하여 학생들의 독서록 작성을 돕고, 교사들의 학생 관리를 지원

교사는 기본적인 업무 + 수업준비 + 학생관리 등 시간이 매우 부족한 상황.
초등학생의 독서록은 지식적, 정신적으로 함양하기 위해 필요한 것, 독서가 필요한 상황이고 이에 할당할 시간이 매우 적다.
...
- AI 첨삭 기능을 통해 문법 및 논리적 표현력 강화
  매 번 선생님이 피드백하기 힘든 내용에 대해 AI를 통해 문법검사, 독서록 내용 피드백 기능을 제공
  본인의 의견(교사)도 작성이 가능.
  숙제도서, 추천도서, 학년도서 분리해서 학생들이 볼 수 있다.

학생들은 본인이 작성한 독서록에 대해 매번 피드백 받을 수 있다. 읽은 책, 작문 내용 검사를 간편하게 받는다.
독서록을 시각적으로 볼 수 있다.

### **교사 기능**

- **학생 독서 이력 열람 및 관리**
    - 학생별 독서 기록과 이력을 바탕으로 맞춤형 독서록 지도 가능
- **독서 토론방 개설 (RTC 활용)**
