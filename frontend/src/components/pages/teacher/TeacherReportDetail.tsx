    ...
    <div className="flex flex-row justify-between">
      <div className="flex flex-col w-[600px]">
       ...
       `}
        ...
        <div className="flex justify-end">
          <div className="inline-flex py-[12px] px-[16px] bg-primary-500 rounded-[10px] justify-center items-center text-center text-white body-medium">
            도장 찍기
          </div>
        </div>
      </div>
      <div className="flex flex-col w-[600px]">
        ...
        <div className="flex justify-end w-[413px]">
          <div className="inline-flex py-[12px] px-[16px] border border-secondary-500 rounded-[10px] justify-center items-center text-center text-secondary-500 body-medium">
            의견 수정
          </div>
        </div>
      </div>
