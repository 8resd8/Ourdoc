const TeacherReportList = () => {
  return (
    <div className="">
      <div className="w-[226px] h-[914px] left-0 top-[110px] absolute bg-white border-r border-[#e0e0e0]  overflow-hidden">
        <div className="w-[194px] p-2 left-[16px] top-[56px] absolute border-b border-black justify-between items-center inline-flex">
        ...
        <div className="w-[226px] h-[796px] left-0 top-[112px] absolute bg-white border-t border-[#e0e0e0]" />
        <div className="left-[16px] top-[24px] absolute text-[#2c2c2c] text-xs font-normal font-['Pretendard'] leading-none">
          도서 검색
        </div>
        <div className="left-[16px] top-[136px] absolute text-[#2c2c2c] text-xs font-normal font-['Pretendard'] leading-none">
          반별 조회
        </div>
        <div className="h-[296px] left-0 top-[164px] absolute flex-col justify-start items-start gap-4 inline-flex">
          <div className="h-[136px] relative">
            ...
            <div className="w-[226px] h-10 px-10 py-2 left-0 top-[96px] absolute bg-white flex-col justify-start items-start gap-2 inline-flex">
              <div className="text-[#2c2c2c] text-base font-normal font-['Pretendard'] leading-normal">
                성천초 1학년 7반
              </div>
            </div>
            <div className="w-[226px] h-10 px-4 py-2 left-0 top-0 absolute flex-col justify-start items-start gap-2 inline-flex">
              <div className="self-stretch grow shrink basis-0 justify-start items-center gap-2 inline-flex">
                ...
                <div className="text-[#2c2c2c] text-base font-bold font-['Pretendard'] leading-normal">
                  2025년도
                </div>
              </div>
            </div>
      ...
      <div className="w-[158px] h-[914px] left-[227px] top-[110px] absolute bg-white border-r border-[#e0e0e0]">
        <div className="left-[16px] top-[24px] absolute text-center text-[#2c2c2c] text-xs font-normal font-['Pretendard'] leading-none">
          학생별 보기
        </div>
        <div className="h-[184px] left-0 top-[52px] absolute flex-col justify-start items-start gap-2 inline-flex">
          <div className="self-stretch h-10 px-4 py-2 bg-white justify-start items-center gap-2 inline-flex">
            <div className="text-center text-[#2c2c2c] text-sm font-normal font-['Pretendard'] leading-tight">
              1번
            </div>
            <div className="w-[97px] text-[#2c2c2c] text-base font-normal font-['Pretendard'] leading-normal">
              김보민
            </div>
          </div>
      ...
      <div className="left-[405px] top-[254px] absolute flex-col justify-start items-center gap-3 inline-flex">
        <div className="w-[858px] h-[567px] relative">
          <div className="h-12 px-6 py-3 left-0 top-0 absolute border-b border-black justify-start items-center gap-[18px] inline-flex">
            <div className="w-[60px] text-center text-[#2c2c2c] text-base font-normal font-['Pretendard'] leading-normal">
              No
            </div>
            <div className="w-60 text-[#2c2c2c] text-base font-normal font-['Pretendard'] leading-normal">
              도서명
            </div>
            <div className="w-[60px] text-center text-[#2c2c2c] text-base font-normal font-['Pretendard'] leading-normal">
              번호
            </div>
            <div className="w-[120px] text-center text-[#2c2c2c] text-base font-normal font-['Pretendard'] leading-normal">
              학생 이름
            </div>
            <div className="w-[120px] text-center text-[#2c2c2c] text-base font-normal font-['Pretendard'] leading-normal">
              제출 날짜
        ...
        <div className="justify-start items-center gap-2 inline-flex">
          ...
          <div className="text-center">
            <span className="text-[#2c2c2c] text-base font-normal font-['Pretendard'] leading-normal">
              1
            </span>
            <span className="text-[#8c8c8c] text-base font-normal font-['Pretendard'] leading-normal">
              {' '}
            </span>
            <span className="text-[#8c8c8c] text-sm font-normal font-['Pretendard'] leading-tight">
              / 24
            </span>
          </div>
          <div data-svg-wrapper className="relative">
