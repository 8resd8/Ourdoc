        ...
        <div className="w-[414px] mt-11 bg-gray-0 rounded-xl  mr-4">
          ...
          <div className="mt-6">
            <div className="mb-2">
              ...
              <div className="mt-[8px] h-[40px] body-medium">usertest</div>
            </div>
            <div className="mb-2">
            ...
            <div className="mb-4">
              ...
              <div className="mt-[8px] h-[40px] body-medium ">
                2001년 1월 3일
              </div>
            </div>
            <button className="w-[414px] h-[56px] border border-gray-500 body-medium text-gray-500 py-2 rounded-lg mb-2 hover:bg-gray-200">
              비밀번호 초기화
            </button>
            <button className="w-full h-[56px] text-system-danger border py-2  border-system-danger rounded-lg hover:bg-primary-200">
              방출하기
            </button>
          </div>
        </div>
