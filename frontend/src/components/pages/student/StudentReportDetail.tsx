    ...
    <div className="flex flex-row justify-between">
      ...
      <div className="flex flex-col w-[600px]">
        <div>
          ...
          <div className="w-[413px] h-[421px] px-6 py-4 rounded-[5px] border border-[#e0e0e0] justify-center items-center gap-2.5 inline-flex">
        ...
        <div>
          ...
          <div className="w-[413px] h-[126px] px-6 py-4 rounded-[5px] border border-[#e0e0e0] justify-center items-center gap-2.5 inline-flex">
            <div className="w-[389px]">
              <span className="text-[#2c2c2c] text-base font-normal font-['Pretendard'] leading-normal">
