    ...
    <div className="flex justify-center items-center ">
      <div className="">
        <div className="border-b border-gray-200 w-[calc(100vw_-_20px)]">
          ...
          <div className="w-[1064px] text-right text-[#4e4e4e] text-sm font-normal font-['Pretendard'] leading-tight mb-2 mt-8 m-auto">
            14권 읽음
          </div>
        </div>
        <div className="w-[1064px] m-auto">
          <div className="text-[#2c2c2c] mt-10 text-[22px] font-semibold font-['Pretendard'] leading-relaxed">
            1월
          </div>
