        ...
        <div className="w-[1064px] m-auto">
          ...
          <div>
              ...
              <div className="self-stretch grow shrink basis-0 justify-center items-center gap-9 inline-flex">
                <div className="w-40 flex-col justify-start items-center gap-2 inline-flex">
                  <div className="self-stretch h-40 px-[19px] py-[49px] rounded-[80px] border border-gray-700 flex-col justify-center items-center gap-2.5 flex">
                    <div>
                      <span className="text-gray-700 text-5xl font-semibold font-['Pretendard'] leading-[54px]">
                        13.5
                      </span>
                      <span className="text-gray-700 text-base font-normal font-['Pretendard'] leading-normal">
                        권
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex-col justify-start items-center gap-2 inline-flex">
                  ...
                  <div className="self-stretch text-center text-gray-800 text-base font-normal font-['Pretendard'] leading-normal">
                    나
                  </div>
                </div>
              </div>
            ...
            <div className="h-[242px] p-6 left-[193px] top-[1632px] absolute bg-white rounded-[15px] shadow-[0px_2px_12px_1px_rgba(33,33,33,0.09)] flex-col justify-start items-start gap-3 inline-flex">
              <div>
                <span className="text-gray-800 text-[22px] font-semibold font-['Pretendard'] leading-relaxed">
                  칭찬도장{' '}
                </span>
                <span className="text-gray-700 text-base font-normal font-['Pretendard'] leading-normal">
                  4개
              ...
              <div className="self-stretch justify-start items-center gap-6 inline-flex">
                ...
                <div className="w-[72px] h-[72px] px-6 py-2.5 rounded-[40px] border border-gray-500 flex-col justify-center items-center gap-2.5 inline-flex">
                  <div className="text-gray-500 text-[26px] font-semibold font-['Pretendard'] leading-[30px]">
                    5
                  </div>
                </div>
                <div className="w-[72px] h-[72px] px-6 py-2.5 rounded-[40px] border border-gray-500 flex-col justify-center items-center gap-2.5 inline-flex">
