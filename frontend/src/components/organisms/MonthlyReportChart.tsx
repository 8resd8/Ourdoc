  ...
  return (
    <div className="w-[630px] h-[368px] p-6 bg-white rounded-[15px] shadow-[0px_2px_12px_1px_rgba(33,33,33,0.09)] flex-col justify-start items-start gap-3 inline-flex">
      ...
      <div className="w-[582px] h-[276px] relative">
        ...
        <div className="left-[63.67px] top-[128.55px] absolute text-center text-primary-500 text-sm font-normal font-['Pretendard'] leading-tight">
          12
        </div>
        ...
        <div className="left-[190.23px] top-[128.55px] absolute text-center text-primary-500 text-sm font-normal font-['Pretendard'] leading-tight">
          12
        </div>
        <div className="left-[362.06px] top-[128.55px] absolute text-center text-primary-500 text-sm font-normal font-['Pretendard'] leading-tight">
          12
        </div>
        <div className="w-[52.66px] h-[276px] px-3 py-6 left-0 top-0 absolute flex-col justify-between items-end inline-flex">
          <div className="text-right text-gray-800 text-base font-normal font-['Pretendard'] leading-normal">
            25권
          </div>
          <div className="text-right text-gray-800 text-base font-normal font-['Pretendard'] leading-normal">
            20권
          ...
          <div className="self-stretch text-right text-gray-800 text-base font-normal font-['Pretendard'] leading-normal">
            5권
          </div>
          <div className="text-right text-gray-800 text-base font-normal font-['Pretendard'] leading-normal">
            0권
