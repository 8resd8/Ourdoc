const ReportItem = ({ date, count }: { date: string; count: number }) => (
  <div className="w-[366px] px-[72px] py-3 border-b border-gray-200 justify-between items-center inline-flex">
    <div className="text-black body-medium">{date}</div>
    <div className="text-black body-medium">{count}권</div>
  </div>
);
...
export const MonthlyReportListSection = () => {
  ...
  return (
    <div className="w-[444px] h-[368px] p-6 bg-white rounded-[15px] shadow-[0px_2px_12px_1px_rgba(33,33,33,0.09)] flex-col justify-start items-start gap-3 inline-flex ">
